...
\begin{titlepage}
  ...
  {\LARGE\bfseries
    A Hybrid MCDM and Ensemble Learning Framework for\\[6pt]
    Performance Indexing: Evidence from Vietnam's PAPI
  \par}
...
\begin{enumerate}[label=\textbf{C\arabic*.}, leftmargin=2.5em]
  ...
  \item \textbf{State-of-the-art ensemble learning for governance forecasting.}
    We construct a three-tier predictive system consisting of: (i)~six
    diverse base models---CatBoost~\citep{Prokhorenkova2018},
    LightGBM~\citep{Ke2017}, Bayesian Ridge, Quantile Random Forest,
    Kernel Ridge Regression, and Support Vector Regression---trained on a
...
%   Threshold track (CatBoost, LightGBM, QRF): variance threshold only
% ----------------------------------------------------------------
\textit{[Content placeholder.]}
...
% ----------------------------------------------------------------
% PLACEHOLDER — 6 diverse base learners:
%   1. CatBoost (joint multi-output MultiRMSE, oblivious trees)
%   2. LightGBM (leaf-wise, MultiOutputRegressor wrapper)
%   3. Bayesian Ridge (PLS-compressed features, posterior uncertainty)
%   4. Quantile Random Forest (full predictive distributions)
%   5. Kernel Ridge Regression (RBF kernel, L2 regularisation)
%   6. Support Vector Regression (epsilon-insensitive tube, RBF)
...
% weight to LightGBM/QRF (tree methods prone to overfitting small T), while
