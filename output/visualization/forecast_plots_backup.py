...
def _build_minimal_payload(**kwargs) -> ForecastVizPayload:
    """
    Construct a minimal ForecastVizPayload from raw arguments.
    Used by facade methods to pass data to chart modules.
    """
    return ForecastVizPayload(
        ...
        current_scores=kwargs.get('current_scores'),
...
class ForecastPlotter(BasePlotter):
    ...
    Phase 4 Note: This class is a facade that delegates to modular chart modules.
    All method signatures remain unchanged for backward compatibility.
    Internally, raw arrays are converted to ForecastVizPayload and delegated to the
    appropriate chart module (AccuracyCharts, EnsembleCharts, etc.).
    """
    ...
    def __init__(self, output_dir: str = '...', dpi: int = 300):
        ...
        # Instantiate all chart modules for delegation
    ...
    # ==================================================================
    #  FIG 16 – Forecast Actual vs Predicted (FACADE)
    # ==================================================================
    ...
    def plot_forecast_scatter(
        ...
        Phase 4: Facade method that delegates to AccuracyCharts.plot_forecast_scatter().
        """
        payload = _build_minimal_payload(
            y_test=actual,
            y_pred_ensemble=predicted,
